...
import com.example.mybackendproject.SpringProject.business.abstracts.ProductService;
...
import com.example.mybackendproject.SpringProject.dataAccess.abstracts.ProductDao;
...
public class ProductManager implements ProductService{
	...
	public DataResult<List<Product>> getAllSorted() {
		...
		return new SuccessDataResult<List<Product>>(this.productDao.findAll(sort),"Sıralama Basarili");
	}
	...
	public DataResult<List<Product>> getAll(int pageNo, int pageSize) {
		...
		return new SuccessDataResult<List<Product>>(this.productDao.findAll(pageAble).getContent(),"Sayfalara göre listelendi.");
	}
	...
	public DataResult<Product> getByProductName(String productName) {
		...
		(this.productDao.getByProductName(productName),"Ürün isimleri Listelendi");
	}
	...
	public DataResult<List<ProductWithCategoryDto>> getProductWithCategoryDetails() {
		...
		return new SuccessDataResult<List<ProductWithCategoryDto>>(this.productDao.getProductWithCategoryDetails(),"Product ve Category Detayları Listelendi.");
	}
